...
setup(
    ...
    description="Pyoilerplate argparse wrapper",
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/landonb/pyoiler-argparse',
    ...
    keywords='argparse pyoilerplate development',
    ...
    #   Installing pyoiler_argparse script to /usr/local/bin
    #   error: [Errno 13] Permission denied: '/usr/local/bin/pyoiler_argparse'
    #entry_points={
    #    'console_scripts': [
    #        'pyoiler_argparse=pyoiler_argparse:main',
    #    ],
    #},
)
